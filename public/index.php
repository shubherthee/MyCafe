...
// Use this base path for XAMPP htdocs without virtual host.
$app->setBasePath('/mycampus-cafe-slim-api/public');

// Middleware: parse JSON/form request body.
$app->addBodyParsingMiddleware();

// Middleware: enable routing and error display during development.
$app->addRoutingMiddleware();
$app->addErrorMiddleware(true, true, true);

// Middleware: allow frontend requests from another origin.
